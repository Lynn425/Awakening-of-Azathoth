...
public class PatternAwareLetterFreqGuesser implements Guesser {
    ...
    public Map<Character, Integer> getFreqMapThatMatchesPattern(String pattern) {
        ...
        if (sizeThatMatchesPattern == 0) {
            ListThatMatchesPattern = words;
            sizeThatMatchesPattern = size;
        }
    ...
    public char getGuess(String pattern, List<Character> guesses) {
        Map<Character, Integer> FrequencyMap = getFreqMapThatMatchesPattern(pattern);
